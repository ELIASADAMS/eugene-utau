...
- **Commercial use:** Contact the author for approval. NFTs or crypto-related use is strictly prohibited.
- **Editing:** Freely edit, convert, or use the voicebank for music, video, or other singing synthesizer projects.
- **Redistribution:** Before discontinuation, you may redistribute with clear notes about changes and attribution. After, only distribute the entire unedited bank with full credit.
